...
class word2vec():
    ...
    def init_op(self):
        ...
        self.summary_writer = tf.summary.FileWriter(self.logdir, self.sess.graph)   
                             # tf.train.SummaryWriter(self.logdir, self.sess.graph)
...
if __name__=='__main__':
    ...
    data5 = '尊者'
    data6 = '皱眉'
    test_word = [ data1.encode('gb2312') , data2.encode('gb2312') , data3.encode('gb2312') , 
                  data4.encode('gb2312') , data5.encode('gb2312') , data6.encode('gb2312') ]
